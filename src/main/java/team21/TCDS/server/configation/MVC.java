 ...
 * <p>
 * 该Spring配置类主要负责配置TCDS网页服务器的基本处理行为，并在IOC容器中生成所需的工具实例。
 * </p>
 *
 ...
 */
@Configurable
@ComponentScan({"team21.TCDS.server.controller", "team21.TCDS.server.service.impl", "team21.TCDS.server.util"})
@ServletComponentScan({"team21.TCDS.server.listener", "team21.TCDS.server.filter"})
...
public class MVC extends ResourceHttpRequestHandler implements WebMvcConfigurer {
    ...
    // 生成Gson实例，用于服务Json序列化和反序列化，或者也可以使用阿里巴巴的
    @Bean
    public Gson gson() {
