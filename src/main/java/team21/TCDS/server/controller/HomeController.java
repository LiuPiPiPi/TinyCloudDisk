...
import team21.TCDS.server.service.*;
 ...
 * <h2>主控制器</h2>
 * <p>
 * 该控制器用于负责处理TCDS主页（home.html）的所有请求，具体过程请见各个方法注释。
 * </p>
 *
...
//	private FileChainService fcs;
    ...
    //该方法用于获取指定文件夹下的分段文件数据列表，从而确保页面加载完整的文件夹数据。该方法可视作getFolderViewToJson方法的后续操作。
