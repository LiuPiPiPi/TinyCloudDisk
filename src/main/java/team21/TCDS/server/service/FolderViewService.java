 ...
 * 该服务层用于查询、拼装、处理文件夹视图的相关请求，是TCDS核心功能的主要组成之一。
 * </p>
...
public interface FolderViewService{
	 ...
	 * @param request 请求对象
	 * @return java.lang.String 该文件夹视图的JSON格式，原型详见team21.TCDS.server.pojo.FolderView类。
	 */
     ...
     * @return java.lang.String 该文件夹视图的JSON格式，原型详见team21.TCDS.server.pojo.SreachView类。
     */
     ...
     * @return java.lang.String 该文件夹后续视图的JSON格式，原型详见team21.TCDS.server.pojo.RemainingFolderView类。
     */
