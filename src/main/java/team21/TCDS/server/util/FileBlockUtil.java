...
public class FileBlockUtil {
	 ...
	 * @author 高级软件21组(team21)
	 * @param f
	 *            team21.TCDS.server.model.Node 要删除的文件节点对象
	 ...
	 * @author 高级软件21组(team21)
	 * @param f
	 *            team21.TCDS.server.model.Node 要获得的文件节点对象
	 ...
	 * @author 高级软件21组(team21)
	 * @param n
	 *            team21.TCDS.server.model.Node 待检查的节点
	 ...
	 * @author 高级软件21组(team21)
	 * @param n
	 *            team21.TCDS.server.model.Node 要获取路径的节点
