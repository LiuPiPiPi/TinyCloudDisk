...
public class FileBlockUtil {
     ...
     * </p>
     *
     * @param f team21.TCDS.server.model.Node 要删除的文件节点对象
     ...
     * </p>
     *
     * @param f team21.TCDS.server.model.Node 要获得的文件节点对象
     ...
     * @return team21.TCDS.server.model.Node 操作成功则返回节点对象，否则返回null
     * @author 高级软件21组(team21)
     */
     ...
     * </p>
     *
     * @param n team21.TCDS.server.model.Node 待检查的节点
     ...
     * </p>
     *
     * @param n team21.TCDS.server.model.Node 要获取路径的节点
