...
import team21.TCDS.server.mapper.*;
import team21.TCDS.server.model.*;
...
public class FolderUtil {
     ...
     * 指定文件夹的所有父级文件夹列表，以team21.TCDS.server.model.Folder形式封装。
     ...
     * </p>
     *
     * @param f team21.TCDS.server.model.Folder 要检查的文件夹对象
     ...
     * </p>
     *
     * @param prototype       team21.TCDS.server.model.Folder 要复制的目标文件夹，即复制的样板
     * @param parentFolder    team21.TCDS.server.model.Folder 复制文件夹的父文件夹，指定在哪个路径下创建目标文件夹的副本
     ...
     * @return team21.TCDS.server.model.Folder 完整复制成功则返回复制好的文件夹对象，
     ...
     * </p>
     *
     * @param f team21.TCDS.server.model.Folder 要获取路径的文件夹
