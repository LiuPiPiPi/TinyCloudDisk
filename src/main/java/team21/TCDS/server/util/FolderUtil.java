...
public class FolderUtil {
	 ...
	 * @author 高级软件21组(team21)
	 * @param f
	 *            team21.TCDS.server.model.Folder 要检查的文件夹对象
	 ...
	 * @author 高级软件21组(team21)
	 * @param prototype
	 *            team21.TCDS.server.model.Folder 要复制的目标文件夹，即复制的样板
	 * @param parentFolder
	 *            team21.TCDS.server.model.Folder 复制文件夹的父文件夹，指定在哪个路径下创建目标文件夹的副本
	 * @param newName
	 ...
	 * @author 高级软件21组(team21)
	 * @param f
	 *            team21.TCDS.server.model.Folder 要获取路径的文件夹
