...
/**
 * <h2>TCDS特用版Properties类</h2>
 * <p>
 * 该类用于替代标准的Properties类作为TCDS各项设置参数的数据存储工具。
...
public class TCDSProperties {
     ...
     *
     * @param key          java.lang.String 键名
     * @param defaultValue java.lang.String 若无该配置时返回的替代参数
     * @return 查询到的值，若传入的键无对应值或键为null则返回null
     * @author 高级软件21组(team21)
     */
     ...
     * </p>
     *
     * @param out    java.io.OutputStream 输出流，能够接收文本流
